...
component = 'BAT'
# Set distance
distance = np.arange(101,140,4)
# Set filename for figure
filename = 'Plots/Sdiff_T_B1.png'
# Set models to plot
events=['OUT_REF_1s_mtp500kmPICKLES', 'OUT_ULVZ20km_1s_mtp500kmPICKLES','OUT_ULVZ10km_1s_mtp500kmPICKLES','ULVZ10km_1sPICKLES']
# Set model titles
...
event = 'OUT_ULVZ5km_1s_mtp500kmPICKLES'

sio.savemat(save_path + 'pickle_mat_interface.mat', {'phase': phase, 'component': component, 'event': event, 'dist': distance})
