...
# Data Directory
fk_dir = '/raid3/zl382/Data/Hawaii/20100320/fk_analysis/'
save_dir = '/raid3/zl382/Pictures/BeamForming/traveltime_%d-%ds/' %(1/fmax, 1/fmin)
...
for array_dir in arraylist: # [145::]
    ...
    fig, ax = plt.subplots()
    pp = ax.pcolorfast(cut_time,backazimuth,power,cmap='seismic')  # main plot of power
    ...
    plt.scatter(PeakTime1, PeakBackazimuth1, c='y',marker='*')
    plt.scatter(PeakTime2, PeakBackazimuth2, c='y',marker='*')
    ...
    savename = save_dir + array_name + '_a.png'
    plt.savefig(savename,format='png')

    savename = save_dir +array_name+'_traveltime.npy'
    np.save(savename, [PeakTime1, PeakBackazimuth1, PeakTime2, PeakBackazimuth2, PeakTime1_min, PeakTime1_max, PeakAzi1_min, PeakAzi1_max, PeakTime2_min, PeakTime2_max, PeakAzi2_min, PeakAzi2_max])    
