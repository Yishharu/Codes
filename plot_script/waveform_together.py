...
for j in range(len(events)):
    ...
    seis = read('/raid3/zl382/Data/Synthetics/REF_modelPICKLES/'+'SYN_90.PICKLE',format='PICKLE')
    seistoplot = seis.select(channel = component)[0]
    
    ref_norm = np.max(seistoplot.data)/norm_constant
    
    fmin = [1/30, 1/30, 1/10, 1/10]  
    fmax = [1/10, 1/10, 1, 1]
...
filename = '/home/zl382/Pictures/waveform/Synthetic/new_models_together'+component+'.tiff'       
