...
#            plt.scatter(seis[0].stats['dist'],np.log(A/A0),color = color_toplot[k], marker = 'x') 
        if seis[0].stats['az'] < az_range_1:
            plt.subplot(1,2,1)
            plt.xlim([75,135])
            plt.ylim([-6,6])
            plt.tick_params(labelsize=5)
            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
        elif seis[0].stats['az'] < az_range_2:
            plt.subplot(1,2,2)
            plt.xlim([75,135])
            plt.ylim([-6,6])
            plt.tick_params(labelsize=5)
            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
#        elif seis[0].stats['az'] < az_range_3:
#            plt.subplot(3,3,3)
#            plt.ylim([-6,6])
#            plt.tick_params(labelsize=5)
#            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
#            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
#        elif seis[0].stats['az'] < az_range_4:
#            plt.subplot(3,3,4)
#            plt.ylim([-6,6])
#            plt.tick_params(labelsize=5)
#            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
#            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
#        elif seis[0].stats['az'] < az_range_5:
#            plt.subplot(3,3,5)
#            plt.ylim([-6,6])
#            plt.tick_params(labelsize=5)
#            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
#            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
#        elif seis[0].stats['az'] < az_range_6:
#            plt.subplot(3,3,6)
#            plt.ylim([-6,6])
#            plt.tick_params(labelsize=5)
#            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
#            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
#        elif seis[0].stats['az'] < az_range_7:
#            plt.subplot(3,3,7)
#            plt.ylim([-6,6])
#            plt.tick_params(labelsize=5)
#            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
#            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
#        elif seis[0].stats['az'] < az_range_8:
#            plt.subplot(3,3,8)
#            plt.ylim([-6,6])
#            plt.tick_params(labelsize=5)
#            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
#            plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
#        elif seis[0].stats['az'] < az_range_9:
#            plt.subplot(3,3,9)
#            plt.ylim([-6,6])
#            plt.tick_params(labelsize=5)
#            plt.xlabel('Epicentral Distance (deg)',fontsize=5)
...
#    plt.legend(shadow=True,fontsize=8,fancybox=True,framealpha=0.5)
    ...
    plt.xlabel('Epicentral Distance (deg)',fontsize=5)
    plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
    plt.suptitle('Event ' + event + ' Amplitude Decay', fontsize = 10) 
    filename = '/home/zl382/Pictures/Amplitude/Real_data/azi_whole_' + event + '_PREM_norm.png'
...
#                plt.ylabel('Normlized amplitude (ln(A/A0))',fontsize=5)
        ...
        filename = '/home/zl382/Pictures/Amplitude/Real_data/azi_' + event + '_PREM_norm_T_'+str(T)+'.png'
        plt.savefig(filename)
        plt.close('all')           
