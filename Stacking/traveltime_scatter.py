...
coherence_value = 0.5
data_folder = '/raid1/zl382/Pictures/BeamForming/traveltime_10-20s/'
...
for array in glob.glob(data_folder+'*_traveltime.npy'):
    ...
    and (Azi2_error<12).all() and  (Azi2_error>5).all():
...
plt.figure()
# plt.title(data_folder)
# plt.scatter(center_azi_list_all,BACKAZIMUTH_list+180,c='y',marker='P',label='Reference',zorder=10,alpha=0.3)
